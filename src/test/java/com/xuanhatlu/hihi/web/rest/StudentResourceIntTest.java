...
public class StudentResourceIntTest {
    ...
    private static final String DEFAULT_NAME_STUDENT = "AAAAAAAAAA";
    private static final String UPDATED_NAME_STUDENT = "BBBBBBBBBB";

    private static final String DEFAULT_AGE_STUDENT = "AAAAAAAAAA";
    private static final String UPDATED_AGE_STUDENT = "BBBBBBBBBB";
    ...
    public static Student createEntity(EntityManager em) {
        Student student = new Student()
            .nameStudent(DEFAULT_NAME_STUDENT)
            .ageStudent(DEFAULT_AGE_STUDENT);
        return student;
    }
    ...
    public void createStudent() throws Exception {
        ...
        assertThat(testStudent.getNameStudent()).isEqualTo(DEFAULT_NAME_STUDENT);
        assertThat(testStudent.getAgeStudent()).isEqualTo(DEFAULT_AGE_STUDENT);
    }
    ...
    @Test
    @Transactional
    public void checkNameStudentIsRequired() throws Exception {
        int databaseSizeBeforeTest = studentRepository.findAll().size();
        // set the field null
        student.setNameStudent(null);
    ...
    @Test
    @Transactional
    public void checkAgeStudentIsRequired() throws Exception {
        int databaseSizeBeforeTest = studentRepository.findAll().size();
        // set the field null
        student.setAgeStudent(null);
    ...
    public void getAllStudents() throws Exception {
        ...
        restStudentMockMvc.perform(get("/api/students?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].nameStudent").value(hasItem(DEFAULT_NAME_STUDENT.toString())))
            .andExpect(jsonPath("$.[*].ageStudent").value(hasItem(DEFAULT_AGE_STUDENT.toString())));
    }
    ...
    public void getStudent() throws Exception {
        ...
        restStudentMockMvc.perform(get("/api/students/{id}", student.getId()))
            ...
            .andExpect(jsonPath("$.nameStudent").value(DEFAULT_NAME_STUDENT.toString()))
            .andExpect(jsonPath("$.ageStudent").value(DEFAULT_AGE_STUDENT.toString()));
    }
    ...
    public void updateStudent() throws Exception {
        ...
        updatedStudent
            .nameStudent(UPDATED_NAME_STUDENT)
            .ageStudent(UPDATED_AGE_STUDENT);
        ...
        Student testStudent = studentList.get(studentList.size() - 1);
        assertThat(testStudent.getNameStudent()).isEqualTo(UPDATED_NAME_STUDENT);
        assertThat(testStudent.getAgeStudent()).isEqualTo(UPDATED_AGE_STUDENT);
    }
