...
import com.xuanhatlu.hihi.service.PersonService;
import com.xuanhatlu.hihi.service.dto.SearchPersonDTO;
import com.xuanhatlu.hihi.web.rest.errors.BadRequestAlertException;
import com.xuanhatlu.hihi.web.rest.util.HeaderUtil;
import com.xuanhatlu.hihi.service.dto.PersonDTO;
...
public class PersonResource {
    ...
    @Timed
    public List<PersonDTO> searchPerson(@RequestBody SearchPersonDTO searchPersonDTO) throws URISyntaxException{
        log.debug("REST request to search Person : {}", searchPersonDTO);
        List<PersonDTO> personDTOS = personService.seachByName(searchPersonDTO.getName());
        return personDTOS;
    }
}
